...
import { createConvocationSchema, updateConvocationSchema, getConvocationsQuerySchema } from '../schemas/convocation.schema.js';
...
router.get('/', auth, cacheMiddleware('convocations:', 120), role([2, 4]), validateData(getConvocationsQuerySchema, 'query'), convocationCtrl.getAllConvocations);
